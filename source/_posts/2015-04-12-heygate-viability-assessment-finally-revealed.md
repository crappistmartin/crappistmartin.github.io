...
Savills (who conducted the viability assessment) claimed that xx% _"does not meet or exceed an acceptable risk-adjusted market return and is therefore unviable"_. In his [Tribunal evidence](https://www.dropbox.com/s/ljlg8vgt2zywied/RobHeasmanLegallyPrivileged%26Confidential.pdf), Lend Lease's Development Director explained that a viable scheme was not one which breaks even, but "_one which delivers an adequate rate of return for the developer"_(para 56). He went on to explain that _"Lend Lease is, of course, a profit-making company and, as a listed company, is responsible to its shareholders"_(para 57); and that _"if investors do not have confidence that they will earn an adequate rate of return on their investment, the project will not be fundable."_(para 58)

Lend Lease [reported](http://www.smh.com.au/business/property/bluewater-sale-inflates-lend-lease-profit-20140827-108w3h.html) net profits (after tax) this year of £450m (AUD $822m). 
...
It claimed that Lend Lease should be entitled to at least 20% profit, because this is the minimum profit required _"in order to secure development funding"_ (para 7.6). But we found in its annual report that Lend Lease will be funding the scheme itself via its 'Integrated Property Model'[^3]. This also means that its construction subsidiary will be creaming off profits from the development accounting in addition to the 20% developer's priority return. 

Developers of the Neo Bankside development were happy with a 13% profit margin in their [viability assessment](http://planningonline.southwark.gov.uk/DocsOnline/Documents/6014_1.pdf) and this was a development on private land with no council involvement. We don't understand why Lend Lease is requiring 20% when the lions share of the risk is borne clearly by the council: The council is the landowner, development partner and planning authority; it has so far spent £65m emptying[^4] & £20m demolishing[^5] the estate where Lend Lease has spent just £14m[^6]; Paragraph 75 of the [Project Director's evidence](https://www.dropbox.com/s/o5cnv7qtjcvdnpf/Southwark-Jon%20Abbott.pdf) says that _"Lend Lease is entitled under the Regeneration Agreement to pull out of the project"_ and the following paragraph says that the council would be required to reimburse Lend Lease _"the sum of around £10m"_ if it did so; the council has so far received £15m in phased land payments which will eventually total £50m[^7] equalling less than its total expenditure on the scheme. 

There will also be extra profit - known as overage or 'super-profit' - which is any surplus profit left over and cannot be quantified until the development is complete. Furthermore, because Lend Lease maintains full control of the business model, any overage is calculated by Lend Lease on a good faith basis. Needless to say, Lend Lease's [track record](http://www.nytimes.com/2012/04/25/nyregion/lend-lease-expected-to-admit-to-fraud-scheme.html?) in [large scale PFI](http://www.thelondonmagazine.co.uk/property-experts/expert-opinions/the-olympic-village.html)s is hardly exemplary and if its [Sydney harbour development](http://www.smh.com.au/nsw/valuation-dispute-poses-threat-to-1b-return-from-barangaroo-20121206-2ay9e.html) is anything to go by Southwark will have to resort to litigation if it wants to recoup any overage. 
...
Evening Standard estimates between £800 and £1,000 per square foot (http://www.homesandproperty.co.uk/property-news/new-homes/live-alongside-londons-new-cycle-superhighway-quickest-commutes)  
...
## Overestimations
VA shows financing costs are high. But rather than borrowing, Lend Lease has admitted that it's financing the scheme itself. Vertical model, and Last year it sold its stake in Greenwich and announced it would be investing the £100m receipt into its Elephant and Castle scheme. 



The viability assessment enabled LL to forgo the payment of £90 worth of affordable housing(10%).

## leaseholders
As part of the process, the viability assessment needed to assess the existing use value of the Heygate site. This included a valuation of the existing homes on the estate. 

## Pessimistic forecast
Lend Lease estimated that property prices would increase by xx% each year - they have actually risen 37% in Southwark since the viability assessment was submitted. 
...
A section of the viability assessment provides a valuation of the leasehold properties on the estate. 

Image of table showing Savills valuations. Table of settlements paid to Heygate leaseholders. 
...
link to question - £59k spent on barristers fees paid by LL : http://moderngov.southwark.gov.uk/documents/s47631/Members%20Question%20Time%20Report%20with%20responses.pdf
 ...
 "realise  the  value of  this  strategically  placed  site" (Jon Abbot CPO evidence, para. 3.9)

 the "deal on offer substantially undervalued the Council's land holding." (Jon Abbot - Witness statement to Feb 2014 Upper Tribunal)

Factsheet:
1.In 1998, Southwark carried out an 'options appraisal study' looking at different options for the Heygate estate. The study recommended the demolition of some of the estate's perimeter blocks and refurbishment of remaining buildings on the estate. Southwark rejected this on the grounds that full demolition would'enable it to realise the land value'.

1. All new developments at Elephant's regeneration were originally supposed to have fifty percent affordable housing (issuu). This would have provided the new Heygate with 600 new social rented homes, instead we are getting just 79. 
...
Look up other benchmarks, see what GLA recommend or other boroughs. Also check out what Argus and other appraisal systems use as benchmark.(ask George)
Is the 20% also applied to the affordable housing, if so then quote the Earls Court development DVS report which said only 10% is reasonable.

The difference between the 'market price' and the price paid for the Heygate and the EUV - why is Southwark selling it for £50m when the market value is £xxm and the EUV is £50m?

2007 Council report estimates the Heygate value at £150m http://moderngov.southwark.gov.uk/Data/Overview%20&%20Scrutiny%20Committee/20070709/Agenda/Cover%20report.pdf

Colley admits that there is unlikely to be any profit in this SN article: heygate.github.io/img/SNDocumentBlunder7Feb2013.pdf
...
Examine the word viable and profitable

By its own overly modest estimate Lend Lease is expecting to make at least £200m profit from its expropriation of our homes, that's £200k profit on the back of each Heygate household forced from the estate. 

Lend Lease is making at least £200m profit on the back of each Heygate household forced from their homes.
...
[^2]: See pg 85 of the [Regeneration Agreement](http://southwarknotes.files.wordpress.com/2013/02/ra.pdf)
